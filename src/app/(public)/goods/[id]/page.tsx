...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description:
      'Мини-бокс с тремя порциями рамена, сладостями, палочками Pocky и морской капустой нори. Лёгкий способ устроить атмосферный азиатский вечер дома.',
    specs: {
      Комплектация: '3× рамен, палочки, соус, нори, сладости, кунжут, стикер',
      'Страна вкуса': 'Корея и Азия',
      'Вес набора ~': '0.5–0.7 кг',
      'Размер коробки': '240×170×100 мм, микрогофра',
    },
    ingredients:
      'Состав зависит от конкретного рамена и снеков. Возможны следы глютена, сои, кунжута.',
    shipping: 'Доставка в ПВЗ Wildberries',
  ...
  },
  {
    ...
    description:
      'Мини-бокс с тремя порциями рамена, сладостями, палочками Pocky и морской капустой нори. Идеально для уютного вечера под K-дорамы или просто азиатской еды дома.',
    specs: {
      Комплектация: '3× рамен, палочки, соус, нори, сладости, кунжут, стикер',
      'Страна вкуса': 'Корея и Азия',
      'Вес набора ~': '0.5–0.7 кг',
  ...
  },
  {
    ...
    specs: {
      Комплектация: '6× рамен, палочки, соус, нори, сладости, кунжут',
      'Страна вкуса': 'Корея и Азия',
      'Вес набора ~': '0.9–1.1 кг',
      'Размер коробки': '300×240×130 мм, микрогофра',
    },
  ...
  },
  {
    ...
    description:
      'Мини-набор с тремя порциями острого рамена, сладостями, палочками и морской капустой нори. Быстрый способ устроить острый и атмосферный азиатский вечер дома.',
    specs: {
      Комплектация: '3× рамен, палочки, соус, нори, сладости, кунжут',
      'Страна вкуса': 'Корея и Азия',
      'Вес набора ~': '0.5–0.7 кг',
      'Размер коробки': '240×170×100 мм, микрогофра',
    },
  ...
  },
  {
    ...
    price: 990,
    images: [
      '/images/ramens/cheese/1.png',
      '/images/ramens/cheese/2.png',
      '/images/ramens/cheese/3.png',
    ],
    badges: [],
    short: 'Сливочный азиатский набор с сырным раменом 🧀',
    description:
      'Нежный азиатский набор: рамен с сырным вкусом, сладости, соус, нори и палочки. Для любителей мягких и молочных ноток в корейской кухне.',
    specs: {
      Комплектация: '3× рамен, палочки, соус, нори, сладости, кунжут',
      'Страна вкуса': 'Корея и Азия',
      'Срок годности': 'см. на упаковке',
    ...
    ingredients:
      'Состав зависит от конкретного рамена и снеков. Возможны следы глютена, сои, кунжута.',
    shipping: 'Доставка в ПВЗ Wildberries',
    wbUrl: 'https://www.wildberries.ru/catalog/953441707/detail.aspx',
    ozonUrl: null,
  },
  {
    id: 7,
    ...
    price: 990,
    images: [
      '/images/ramens/carbonara/1.png',
      '/images/ramens/carbonara/2.png',
      '/images/ramens/carbonara/3.png',
    ],
    badges: [],
    short: 'Итальянско-корейский фьюжн: рамен карбонара 🍝',
    description:
      'Уникальное сочетание сыра, бекона и корейского характера. Рамен карбонара в азиатском стиле, сладости, соус, нори и палочки.',
    specs: {
      Комплектация: '3× рамен, палочки, соус, нори, сладости, кунжут',
      'Страна вкуса': 'Корея и Азия',
      'Срок годности': 'см. на упаковке',
    ...
    ingredients:
      'Состав зависит от конкретного рамена и снеков. Возможны следы глютена, сои, кунжута.',
    shipping: 'Доставка в ПВЗ Wildberries',
    wbUrl: 'https://www.wildberries.ru/catalog/953449805/detail.aspx',
    ozonUrl: null,
  },
  {
    id: 8,
    ...
    price: 990,
    images: [
      '/images/ramens/origin/1.png',
      '/images/ramens/origin/2.png',
      '/images/ramens/origin/3.png',
    ],
    badges: [],
    short: 'Классический азиатский набор 🇰🇷',
    description:
      'Традиционный рамен, сладости, нори и палочки. Чистый вкус Кореи без лишних добавок.',
    specs: {
      Комплектация: '3× рамен, палочки, соус, нори, сладости, кунжут',
      'Страна вкуса': 'Корея и Азия',
      'Срок годности': 'см. на упаковке',
    ...
    ingredients:
      'Состав зависит от конкретного рамена и снеков. Возможны следы глютена, сои, кунжута.',
    shipping: 'Доставка в ПВЗ Wildberries',
    wbUrl: 'https://www.wildberries.ru/catalog/953463684/detail.aspx',
    ozonUrl: null,
  },
  {
    id: 9,
    ...
    price: 990,
    images: [
      '/images/ramens/nong-classicbox/1.png',
      '/images/ramens/nong-classicbox/2.png',
      '/images/ramens/nong-classicbox/3.png',
    ],
    badges: [],
    short: 'Премиум набор с раменом Nongshim 🍜',
    description:
      'Легендарный рамен Nongshimi 3шт с богатой историей, сладости, соус, нори и палочки. Классические вкусы в премиум исполнении.',
    specs: {
      Комплектация: '3× рамен, палочки, соус, нори, сладости, кунжут',
      'Страна вкуса': 'Корея и Азия',
      'Срок годности': 'см. на упаковке',
    ...
    ingredients:
      'Состав зависит от конкретного рамена и снеков. Возможны следы глютена, сои, кунжута.',
    shipping: 'Доставка в ПВЗ Wildberries',
    wbUrl: 'https://www.wildberries.ru/catalog/953490305/detail.aspx?targetUrl=GP',
    ozonUrl: null,
  },
  {
    id: 10,
    ...
    price: 990,
    images: [
      '/images/ramens/nong-tom-yum/1.png',
      '/images/ramens/nong-tom-yum/2.png',
      '/images/ramens/nong-tom-yum/3.png',
    ],
    badges: [],
    short: 'Тайско-корейский набор с том-ям раменом 🥥',
    description:
      'Вкуснейшие вкусы том-ям, сыр Nongshimi, сладости, соус, нори и палочки в комплекте.',
    specs: {
      Комплектация: '3× рамен, палочки, соус, нори, сладости, кунжут',
      'Страна вкуса': 'Корея и Азия',
      'Срок годности': 'см. на упаковке',
    ...
    ingredients:
      'Состав зависит от конкретного рамена и снеков. Возможны следы глютена, сои, кунжута.',
    shipping: 'Доставка в ПВЗ Wildberries',
    wbUrl: 'https://www.wildberries.ru/catalog/953481120/detail.aspx?targetUrl=GP',
    ozonUrl: null,
  },
];
...
export default function ProductPage() {
  ...
  const product = useMemo(() => {
    ...
    return PRODUCTS.find((p) => p.id === pid || p.slug === (params?.id || '').toString());
  }, [params]);
      ...
      <Grid>
        ...
        <Right>
          ...
          <PriceRow>
            ...
            <div className='cta'>
              {product.wbUrl && (
                <WbButton as='a' href={product.wbUrl} target='_blank' rel='noreferrer'>
                  Купить на <WBIcon />
                </WbButton>
              )}
              {product.ozonUrl && (
                <OzonBtn as='a' href={product.ozonUrl} target='_blank' rel='noreferrer'>
                  Купить на <OzonIcon />
                </OzonBtn>
              )}
            </div>
          ...
          <Tabs>
            ...
            <button data-active={tab === 'specs'} onClick={() => setTab('specs')}>
              Характеристики
            </button>
          ...
          <TabBody>
            ...
            {tab === 'ship' && <p>{product.shipping ?? 'Информация о доставке появится позже.'}</p>}
          </TabBody>

          <SmallNote>
            * Фото носит ознакомительный характер. Комплектация может слегка отличаться (в рамках
            концепции набора).
          </SmallNote>
        </Right>
      </Grid>
