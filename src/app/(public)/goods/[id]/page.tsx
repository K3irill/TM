...
const PRODUCTS: Product[] = [
	...
	},
	{
		...
		specs: {
			Комплектация: '6× рамен, палочки, соус, кимчи, стикер',
			'Страна вкуса': 'Корея',
	...
	},
	{
		...
		price: 1299,
		oldPrice: 1499,
		images: ['/images/goods/anime.webp'],
		badges: [{ text: 'Limited', tone: 'limited' }],
		short: 'Мини-фигурка аниме девочки — собери коллекцию ✨',
		description: 'Мини-фигурка аниме девочки — собери коллекцию ✨',
		specs: {
			Комплектация: '1x Мини-фигурка',
			Страна: 'Китай',
		},
		shipping:
			'Доставка по РФ. Самовывоз/СДЭК. Оплата картой. Возврат не скрытой/нераспечатанной еды в течение 7 дней.',
